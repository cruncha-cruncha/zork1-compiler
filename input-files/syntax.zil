...
<SYNTAX (WHERE) WHERE AM I>
<SYNTAX (WHERE) WHERE CAN I GO>
<SYNTAX (WHERE) WHAT CAN I DO>
<SYNTAX (WHAT) WHAT IS HERE>
<SYNTAX (TIME) TIME>
...
<SYNTAX (SLEEP) SLEEP>
<SYNTAX (CHEAT) CHEAT OBJECT>
<SYNTAX (DEBUG) DEBUG>

<SYNTAX (EXAMINE) EXAMINE OBJECT>
<SYNONYM EXAMINE INSPECT READ INVESTIGATE>
<SYNTAX (TAKE) TAKE OBJECT>
<SYNONYM TAKE GATHER GET GRAB>
<SYNTAX (DROP) DROP OBJECT>
<SYNTAX (EMPTY) EMPTY OBJECT>
<SYNONYM EMPTY UNPACK>
<SYNTAX (ADD) ADD OBJECT TO OBJECT>
<SYNTAX (ADD) PUT OBJECT IN OBJECT>
<SYNTAX (HIT) HIT OBJECT WITH OBJECT>
<SYNONYM HIT SMASH>
<SYNTAX (WORK) WORK OBJECT WITH OBJECT>

<SYNTAX (EAT) EAT OBJECT>
<SYNONYM EAT TASTE LICK DRINK IMBIBE>
<SYNTAX (OPEN) OPEN OBJECT>
<SYNTAX (SPARK) SPARK OBJECT AT OBJECT>
<SYNTAX (TALK) TALK TO OBJECT>
<SYNTAX (PEE) PEE ON OBJECT>
<SYNTAX (WRITE) WRITE NOTE>

<SYNTAX (ENTER) ENTER CABIN>
<SYNTAX (EXIT) EXIT CABIN>
<SYNTAX (SWIM) SWIM>
<SYNTAX (JUMP) JUMP IN>
<SYNTAX (JUMP) JUMP DOWN>

<SYNTAX (GREAT) GREAT BALL FIRE> ;"bat"
<SYNTAX (EUNICE) EUNICE BROKE HEART> ;"owl"
<SYNTAX (SCHOOL) SCHOOL IS FOR ME> ;"fish"
<SYNTAX (BUG) BUG THAT BIG> ;"frog"
<SYNTAX (EVER) EVER PLAY LOTTERY> ;"rabbit"
<SYNTAX (LISTENING) LISTENING TO RIVER> ;"snake"
<SYNTAX (GROWING) GROWING UP BACK HOME> ;"crow"
<SYNTAX (YES) YES>
<SYNTAX (NO) NO>
